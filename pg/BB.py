...
player_image = pg.transform.scale(pg.image.load('BB_assets/player.gif').convert_alpha(), (tile_width, tile_height))
...
tile_images = {
    'wall': pg.transform.scale(pg.image.load('BB_assets/box.png'), (tile_width, tile_height)),
    'empty': pg.transform.scale(pg.image.load('BB_assets/floor.png'), (tile_width, tile_height))
}
player, level_x, level_y = generate_level(load_level('BB_levels/map.txt'))
